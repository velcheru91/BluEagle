...
extern void xPortPendSVHandler(void);							    // PendSV Handler
extern void vPortSVCHandler(void);             
/* Implemented in handlers.c */
extern void SysTick_Handler(void) __attribute__((weak));            // SysTick Handler
extern void GpioAIntHandler(void) __attribute__((weak));          // GPIO Port A
extern void GpioBIntHandler(void) __attribute__((weak));          // GPIO Port B
extern void GpioCIntHandler(void) __attribute__((weak));          // GPIO Port C
extern void GpioDIntHandler(void) __attribute__((weak));          // GPIO Port D
extern void GpioEIntHandler(void) __attribute__((weak));          // GPIO Port E
...
extern void GpioFIntHandler(void) __attribute__((weak));            // GPIO Port F
...
extern void Uart0IntHandler(void) __attribute__((weak));            // UART0 Rx and Tx
extern void Uart1IntHandler(void) __attribute__((weak));            // UART1 Rx and Tx
extern void Uart2IntHandler(void) __attribute__((weak));              // UART2 Rx and Tx
...
extern void Uart3IntHandler(void) __attribute__((weak));              // UART3 Rx and Tx
extern void Uart4IntHandler(void) __attribute__((weak));              // UART4 Rx and Tx
extern void Uart5IntHandler(void) __attribute__((weak));              // UART5 Rx and Tx
extern void Uart6IntHandler(void) __attribute__((weak));              // UART6 Rx and Tx
extern void Uart7IntHandler(void) __attribute__((weak));              // UART7 Rx and Tx
